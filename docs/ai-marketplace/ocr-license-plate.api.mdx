---
id: ocr-license-plate
title: "OCR License Plate - AI Marketplace"
description: ""
sidebar_label: "OCR License Plate"
hide_title: true
...
api:
  {
    "tags": ["ai-marketplace"],
    "description": "",
    "operationId": "ocrLicensePlateInfer",
    "parameters":
      [
        {
          "type": "apiKey",
    ...
    "servers":
      [
        {
          "url": "https://ocrlicenseplate.infer.visai.ai/predict",
    ...
    "fullURL": "https://ocrlicenseplate.infer.visai.ai/predict",
    "postman": {
        "name": "OCR License Plate Inference",
...
<div class="custom-url-container">
  ...
  <span class="custom-url">https://ocrlicenseplate.infer.visai.ai/predict</span>
</div>
                                ...
                                <details style={{}} data-collapsed={false} open={true}>
                                  ...
                                  <div style={{ marginLeft: "1rem" }}>
                                    ...
                                    <SchemaItem
                                      ...
                                      schemaName={"number"}
                                      qualifierMessage={
                                        "The model's confidence in `plate_id` prediction, expressed as a value between 0 and 1."
                                      }
                                    >
                                    </SchemaItem>
                                  </div>
                                ...
                                <details style={{}} data-collapsed={false} open={true}>
                                  ...
                                  <div style={{ marginLeft: "1rem" }}>
                                    ...
                                    <SchemaItem
                                      ...
                                      schemaName={"number"}
                                      qualifierMessage={
                                        "The model's confidence in `province` prediction, expressed as a value between 0 and 1."
                                      }
                                    >
                                    </SchemaItem>
                                  </div>
