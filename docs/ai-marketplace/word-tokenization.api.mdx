...
title: "Word Tokenization - AI Marketplace"
description: ""
sidebar_label: "Word Tokenization"
hide_title: true
...
api:
  {
    "tags": ["ai-marketplace"],
    "description": "",
    "operationId": "wordTokenizationInfer",
    "parameters":
      [
        {
          "name": "X-API-Key",
                        ...
                        "properties":
                          {
                            ...
                            "tokens":
                              {
                                "type": "array",
                                "description": "List of words splitted from the sentence",
                              },
                          },
                        "title": "ApiResponse",
                      },
    ...
    "jsonRequestBodyExample":
      {
        "inputs":
          ["วิสัยบริษัทผู้พัฒนาแพลตฟอร์ม", "ก่อตั้งเมื่อกุมภาพันธ์ 2022"],
      },
    "method": "post",
    "path": "/predict",
    "servers":
      [
        {
          "url": "https://wordtokenization.infer.visai.ai/predict",
    ...
    "fullURL": "https://wordtokenization.infer.visai.ai/predict",
    "postman":
      {
...
<div class="custom-url-container">
  ...
  <span class="custom-url">https://wordtokenization.infer.visai.ai/predict</span>
</div>
