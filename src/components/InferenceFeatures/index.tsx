...
export default function DocPage(props: Props): JSX.Element {
  ...
  const product =
    pathName === "/docs/customized-ai" ? "Customized AI" : "AI Marketplace";
                      ...
                      >
                        <li className="breadcrumbs__item">
                          ...
                          >
                            <svg
                              viewBox="0 0 24 24"
                              className="breadcrumbHomeIcon_node_modules-@docusaurus-theme-classic-lib-theme-DocBreadcrumbs-styles-module"
                            >
                              <path
